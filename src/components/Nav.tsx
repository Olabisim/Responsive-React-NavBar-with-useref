...
export const Nav = () => {
        ...
        const handleX = () => {
                li1.current.style.transform = `rotate(${toggle ? 0 : 45 }deg)`
                li2.current.style.opacity = `${toggle ? 1 : 0 }`
                li3.current.style.transform = `rotate(-${toggle ? 0 : 45}deg)`
                li3.current.style.marginTop = `-${toggle ? 0 : 16}px`
        ...
        return (
                <div>
                        <header className="h-20 nav-header mt-2 pt-0 p-10" style={{background: "black"}}>
                                ...
                                <div className="container mx-auto flex justify-between items-center">
                                        ...
                                        <div className='hidden lg:flex'>
                                                <a href="#ss" className="Nav-button text-white m-2" role="button">
                                                                Connect Wallet
                                                </a>
                                                {/* <img src="../../avatar.png " className="Nav-avatar mt-3" alt="Tailwindcss Navigat/ion" /> */}
